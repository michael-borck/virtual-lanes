...
<div class="page">
	...
	<div class="sec">Lane &amp; conditions</div>
	...
	<div class="row2">
		<div class="field"><label for="hhcp">Your handicap (pins)</label><input id="hhcp" type="number" inputmode="numeric" bind:value={g.human.handicap} /></div>
		<div class="field">
			<span class="fl">Division (label only)</span>
			<div class="seg">
	...
	<div class="sec">Choose rival(s) · {g.selectedIds.length}/3</div>
	<div class="roster">
	...
	<details style="margin-top:14px;background:var(--panel);border:1px solid var(--line);border-radius:12px;padding:0 12px">
		<summary style="padding:13px 0;color:var(--dim);font-weight:600;cursor:pointer">⚙ Advanced — handicap, breakdown, traffic</summary>
	...
	<button class="cta" style="margin-top:16px" disabled={g.selectedIds.length === 0} onclick={() => g.startGame()}>
